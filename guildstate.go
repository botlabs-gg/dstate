...
func (g *GuildState) runGC(cacheExpirey time.Duration, offlineMembers bool, maxMessages int, maxMessageDuration time.Duration, botID int64) (membersEvicted int, cacheN int, messagesRemoved int) {
	if g.userCache != nil {
